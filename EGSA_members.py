...
logo_path = r"C:\Users\User\Desktop\EGSA2025\assets\EGSA.png"   
...
# 2️⃣ Load & Clean Data
# -------------------------------------------------------
file_path = r"C:\Users\User\Desktop\EGSA2025\data\EGSA2025_info.xlsx"
...
numeric_cols = ["Q1_plan", "Q1_achievement", "Monthly_payment_Q2", "Q2_plan", "fee_charge", "volentary_saving"]
...
ax.bar(totals.keys(), totals.values(), color=['skyblue', 'green', 'orange', 'purple', 'red', 'gold'])
...
if st.button("💾 Save Updated Data to Excel"):
    save_path = r"C:\Users\User\Desktop\EGSA2025\data\EGSA2025_updated.xlsx"
